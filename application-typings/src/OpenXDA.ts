...
namespace OpenXDA {
    ...
    export namespace Types {
		...
		export interface RemoteXDAInstance { ID: number, Name: string, Address: string, Frequency: string, UserAccountID?: string, UseApiAuth: boolean, APIToken?: string, RegistrationKey?: string }

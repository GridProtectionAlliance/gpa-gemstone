...
import { IStartEndWindowProps } from './StartWindowFilter';
import { readableUnit, units } from './TimeWindowUtils';
import QuickSelects from './QuickSelects';

const EndWindowFilter = (props: IFilterProps) => {
        ...
        <div className='row m-0'>
            <div className={props.ShowQuickSelects ? 'col-4' : 'col-6'}>
                <DatePicker<ITimeWindow>
                    ...
                    Setter={(r) => {
                        const flt = getTimeWindowFromFilter({ end: r.end, duration: r.duration, unit: r.unit }, props.Format)
...
export default EndWindowFilter;
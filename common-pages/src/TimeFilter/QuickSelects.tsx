...
interface IProps {
    ...
    /**
     * Optional range used to limit the quick selections shown.
     */
    QuickSelectRange?: Gemstone.TSX.Types.QuickSelectRange
    /**
     * Time zone used when generating quick-selection timestamps.
     */
    Timezone: string,
    /**
     ...
     * @param qp - Index of the quick selection to activate.
     */
    SetActiveQP: (qp: number) => void,
    /**
     * Applies the time window generated by a quick selection.
     * @param start - Generated start value.
     * @param end - Generated end value.
     * @param unit - Unit used by the generated duration.
     * @param duration - Length of the generated time window.
     */
    SetFilter: (start: string, end: string, unit: TimeUnit, duration: number) => void,
    /**
     * Optional flag that wraps the quick selections in a row container, defaulting to true.
     */
    AddRowContainer?: boolean,
    /**
     * Optional flag that widens the quick-select columns, defaulting to false.
     */
    SplitSelects?: boolean,
}

/**
 * Displays predefined time windows that can be applied with one selection.
 * @param props - Time format, quick-select range, active choice, and filter handlers.
 * @returns Responsive quick-selection controls.
 */
...
/**
 * Optionally wraps quick-selection content in a centered Bootstrap row.
 * @param props - Wrapper setting and content to render.
 * @returns Wrapped or unwrapped quick-selection content.
 */

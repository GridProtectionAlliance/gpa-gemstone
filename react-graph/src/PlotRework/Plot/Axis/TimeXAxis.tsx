...
const TimeXAxis = (props: React.PropsWithChildren<ITimeXAxisProps>) => {
    ...
    // Hover state lives in a ref to avoid invalidating the context value on every mousemove. Interested components subscribe via RegisterHover instead.
    ...
    // Local hover label for axis display 

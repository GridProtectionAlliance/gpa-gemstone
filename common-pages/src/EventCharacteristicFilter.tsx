...
const EventCharacteristicFilter = (props: IProps) => {
    ...
    const sagsSelected = props.eventTypeFilter.find(i => i == props.eventTypes.find(item => item.Name == 'Sag')?.ID) != null;
    const swellsSelected = props.eventTypeFilter.find(i => i == props.eventTypes.find(item => item.Name == 'Swell')?.ID) != null;
    const transientsSelected = props.eventTypeFilter.find(i => i == props.eventTypes.find(item => item.Name == 'Transient')?.ID) != null;
